...
## Assembly:
To start, use thermal epoxy to connect the PCB board to the Thorlabs cage plate. It is helpful to use cage rods as an alignment guide to ensure everything it positioned correctly:
![LED driver with cage rods](https://github.com/Llamero/30mm_cage_plate_LED_MCPCB/blob/main/Images/Top%20with%20rods.jpg)
Press firmly with a vise or heavy weight and bake at 50°C overnight to cure.
